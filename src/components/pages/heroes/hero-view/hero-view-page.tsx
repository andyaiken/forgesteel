		...
		return (
			<ErrorBoundary>
				<div className='hero-view-page'>
					...
					<AppFooter page='heroes' heroes={props.heroes} session={props.session} showAbout={props.showAbout} showRoll={props.showRoll} showReference={() => props.showReference(hero)} />
				</div>
			</ErrorBoundary>
		);
	} catch (ex) {
