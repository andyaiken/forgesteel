		...
		return (
			<ErrorBoundary>
				<div className='session-director-page'>
					...
					<AppFooter page='session' heroes={props.heroes} showAbout={props.showAbout} showRoll={props.showRoll} showReference={props.showReference} showSourcebooks={props.showSourcebooks} />
				</div>
			</ErrorBoundary>
		);
	} catch (ex) {
