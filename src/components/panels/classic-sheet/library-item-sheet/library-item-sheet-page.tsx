...
export const LibraryItemSheetPage = (props: Props) => {
	...
	// Built here rather than in a helper so the dependencies stay checkable: the content
	// depends on the page orientation and card layout as well as the item itself
	const content = useMemo(
		...
		[ props.item, props.category, options, layout ]
	);
