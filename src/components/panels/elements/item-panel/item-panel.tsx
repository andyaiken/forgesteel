...
export const ItemPanel = (props: Props) => {
	...
	return (
		<ErrorBoundary>
			<div className={props.mode === PanelMode.Full ? 'item-panel' : 'item-panel compact'} id={props.mode === PanelMode.Full ? SheetFormatter.getPageId('item', item.id) : undefined} style={props.style}>
				<HeaderText
					level={1}
					tags={tags}
				>
