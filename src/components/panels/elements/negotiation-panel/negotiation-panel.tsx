					...
					props.mode === PanelMode.Full ?
						<>
							<Flex align='center' justify='space-evenly'>
								...
								<Field orientation='vertical' label='Interest' value={<Progress percent={props.negotiation.interest * 20} steps={5} showInfo={false} />} />
								<Field orientation='vertical' label='Patience' value={<Progress percent={props.negotiation.patience * 20} steps={5} showInfo={false} />} />
							</Flex>
