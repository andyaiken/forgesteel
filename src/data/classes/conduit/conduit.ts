                    ...
                    options: [
                        {
                            feature: FactoryLogic.feature.createAbilityDamage({
                                ...
                                description:
                                    "Your god infuses wrath within your being.",
                        ...
                        },
                        {
                            feature: FactoryLogic.feature.createMultiple({
                                ...
                                description:
                                    "Your god gives your mind the training of a soldier. You can wear light armor and wield light weapons effectively, even though you don't have a kit. You can use light armor treasures and light weapon treasures. If you have a kit, you can't take this prayer.",
                                features: [
                                    FactoryLogic.feature.createProficiency({
                                        id: "conduit-1-8c-prof",
                                        name: "Soldier's Proficiency",
                                        description:
                                            "You gain proficiency with light armor and light weapons.",
                                    ...
                                    FactoryLogic.feature.createChoice({
                                        ...
                                        description:
                                            "Select which equipment you have to gain bonuses. You can select both, one, or neither.",
                                        count: 2,
                                        options: [
                                            {
                                                feature:
...
Divine power remains until you spend it.`,
    ...
    abilities: [
        ...
        FactoryLogic.createAbility({
            ...
            sections: [
                FactoryLogic.createAbilitySectionText(
                    "The target gains 20 temporary Stamina and 3 surges."
                ),
            ],
        }),
        FactoryLogic.createAbility({
            ...
            sections: [
                ...
                FactoryLogic.createAbilitySectionText(
                    "One ally within distance can spend any number of Recoveries."
                ),
            ],
        }),
        FactoryLogic.createAbility({
            ...
            sections: [
                ...
                FactoryLogic.createAbilitySectionText(
                    "Each ally in the area can spend a Recovery."
                ),
            ],
        }),
        FactoryLogic.createAbility({
