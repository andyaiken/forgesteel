...
export class EnvironmentData {
	static nomadic = FeatureLogic.feature.createSkillChoiceFeature({
		id: 'env-nomadic',
		name: 'Nomadic',
	...
	static rural = FeatureLogic.feature.createSkillChoiceFeature({
		id: 'env-rural',
		name: 'Rural',
	...
	static secluded = FeatureLogic.feature.createSkillChoiceFeature({
		id: 'env-secluded',
		name: 'Secluded',
	...
	static urban = FeatureLogic.feature.createSkillChoiceFeature({
		id: 'env-urban',
		name: 'Urban',
	...
	static wilderness = FeatureLogic.feature.createSkillChoiceFeature({
		id: 'env-wilderness',
		name: 'Wilderness',
...
export class OrganizationData {
	static anarchic = FeatureLogic.feature.createSkillChoiceFeature({
		id: 'org-anarchic',
		name: 'Anarchic',
	...
	static bureaucratic = FeatureLogic.feature.createSkillChoiceFeature({
		id: 'org-bureaucratic',
		name: 'Bureaucratic',
	...
	static communal = FeatureLogic.feature.createSkillChoiceFeature({
		id: 'org-communal',
		name: 'Communal',
...
export class UpbringingData {
	static academic = FeatureLogic.feature.createSkillChoiceFeature({
		id: 'up-academic',
		name: 'Academic',
	...
	static creative = FeatureLogic.feature.createSkillChoiceFeature({
		id: 'up-creative',
		name: 'Creative',
	...
	static illegal = FeatureLogic.feature.createSkillChoiceFeature({
		id: 'up-illegal',
		name: 'Illegal',
	...
	static labor = FeatureLogic.feature.createSkillChoiceFeature({
		id: 'up-labor',
		name: 'Labor',
	...
	static martial = FeatureLogic.feature.createSkillChoiceFeature({
		id: 'up-martial',
		name: 'Martial',
	...
	static noble = FeatureLogic.feature.createSkillChoiceFeature({
		id: 'up-noble',
		name: 'Noble',
