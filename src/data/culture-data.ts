...
export class EnvironmentData {
	static nomadic = FactoryLogic.feature.createSkillChoiceFeature({
		id: 'env-nomadic',
		name: 'Nomadic',
	...
	static rural = FactoryLogic.feature.createSkillChoiceFeature({
		id: 'env-rural',
		name: 'Rural',
	...
	static secluded = FactoryLogic.feature.createSkillChoiceFeature({
		id: 'env-secluded',
		name: 'Secluded',
	...
	static urban = FactoryLogic.feature.createSkillChoiceFeature({
		id: 'env-urban',
		name: 'Urban',
	...
	static wilderness = FactoryLogic.feature.createSkillChoiceFeature({
		id: 'env-wilderness',
		name: 'Wilderness',
...
export class OrganizationData {
	static anarchic = FactoryLogic.feature.createSkillChoiceFeature({
		id: 'org-anarchic',
		name: 'Anarchic',
	...
	static bureaucratic = FactoryLogic.feature.createSkillChoiceFeature({
		id: 'org-bureaucratic',
		name: 'Bureaucratic',
	...
	static communal = FactoryLogic.feature.createSkillChoiceFeature({
		id: 'org-communal',
		name: 'Communal',
...
export class UpbringingData {
	static academic = FactoryLogic.feature.createSkillChoiceFeature({
		id: 'up-academic',
		name: 'Academic',
	...
	static creative = FactoryLogic.feature.createSkillChoiceFeature({
		id: 'up-creative',
		name: 'Creative',
	...
	static illegal = FactoryLogic.feature.createSkillChoiceFeature({
		id: 'up-illegal',
		name: 'Illegal',
	...
	static labor = FactoryLogic.feature.createSkillChoiceFeature({
		id: 'up-labor',
		name: 'Labor',
	...
	static martial = FactoryLogic.feature.createSkillChoiceFeature({
		id: 'up-martial',
		name: 'Martial',
	...
	static noble = FactoryLogic.feature.createSkillChoiceFeature({
		id: 'up-noble',
		name: 'Noble',
