...
export class EnvironmentData {
	...
	static rural = FeatureLogic.createSkillChoiceFeature({
		id: 'env-rural',
		name: 'Rural',
	...
	static secluded = FeatureLogic.createSkillChoiceFeature({
		id: 'env-secluded',
		name: 'Secluded',
	...
	static urban = FeatureLogic.createSkillChoiceFeature({
		id: 'env-urban',
		name: 'Urban',
	...
	static wilderness = FeatureLogic.createSkillChoiceFeature({
		id: 'env-wilderness',
		name: 'Wilderness',
...
export class OrganizationData {
	static anarchic = FeatureLogic.createSkillChoiceFeature({
		id: 'org-anarchic',
		name: 'Anarchic',
	...
	static bureaucratic = FeatureLogic.createSkillChoiceFeature({
		id: 'org-bureaucratic',
		name: 'Bureaucratic',
	...
	static communal = FeatureLogic.createSkillChoiceFeature({
		id: 'org-communal',
		name: 'Communal',
...
export class UpbringingData {
	...
	static creative = FeatureLogic.createSkillChoiceFeature({
		id: 'up-creative',
		name: 'Creative',
	...
	static illegal = FeatureLogic.createSkillChoiceFeature({
		id: 'up-illegal',
		name: 'Illegal',
	...
	static labor = FeatureLogic.createSkillChoiceFeature({
		id: 'up-labor',
		name: 'Labor',
	...
	static martial = FeatureLogic.createSkillChoiceFeature({
		id: 'up-martial',
		name: 'Martial',
	...
	static noble = FeatureLogic.createSkillChoiceFeature({
		id: 'up-noble',
		name: 'Noble',
