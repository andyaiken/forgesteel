			...
			features: [
				...
				FactoryLogic.feature.createAbility({
					ability: FactoryLogic.createAbility({
						...
						sections: [
							...
							FactoryLogic.createAbilitySectionText('The affected area is covered in burning acid. An enemy who enters an affected square for the first time on their turn or starts their turn there takes 2 acid damage.')
						]
					})
				}),
				FactoryLogic.feature.createAbility({
				...
				FactoryLogic.feature.createAbility({
					ability: FactoryLogic.createAbility({
						...
						target: 'Special',
						sections: [
							FactoryLogic.createAbilitySectionText('The ankheg kicks up dust into the affected area that blocks line of effect for enemies. The ankheg then shifts or burrows up to their speed.')
						]
					})
				}),
				FactoryLogic.feature.createAbility({
					ability: FactoryLogic.createAbility({
						...
						target: 'Self',
						sections: [
							FactoryLogic.createAbilitySectionText('The ankheg shifts up to 3 squares.')
						]
					})
				}),
				FactoryLogic.feature.create({
				...
				FactoryLogic.feature.createAbility({
					ability: FactoryLogic.createAbility({
						...
						sections: [
							...
							FactoryLogic.createAbilitySectionText('The ground within the affected area is covered in burning acid. An enemy who enters an affected square for the first time on their turn or starts their turn there takes 2 acid damage.')
						]
					})
				}),
				FactoryLogic.feature.createAbility({
					ability: FactoryLogic.createAbility({
						...
						target: 'Self',
						sections: [
							FactoryLogic.createAbilitySectionText('The ankheg shifts up to their speed by burrowing. If the ankheg ends this move underground and within 2 squares of a creature on the surface, the ankheg uses Bite against the creature.')
						]
					})
				}),
				FactoryLogic.feature.createAbility({
