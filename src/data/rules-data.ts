...
`,
  ...
  static invisibileCreatures: RulesItem = {
...
`,
  ...
  static multitargerForcedMovement: RulesItem = {
    label: "Multitarget Abilities and Forced Movement.",
    content: `
...
`,
  ...
  static multipleTargets: RulesItem = {
    label: "Roll Against Multiple Creatures.",
    content: `
  ...
  static searchingForHiddenCreatures: RulesItem = {
    label: "Searching for Hidden Creatures.",
    content: `
