...
export class SourcebookData {
	static core: Sourcebook = {
		...
		monsterGroups: [
			...
			MonsterData.demon1st,
			MonsterData.demon2nd,
			MonsterData.demon3rd,
			MonsterData.demon4th,
			MonsterData.devil,
			...
			MonsterData.rival1st,
			MonsterData.rival2nd,
			MonsterData.rival3rd,
			MonsterData.rival4th,
			MonsterData.shamblingMound,
			MonsterData.timeRaider,
			MonsterData.troll,
			MonsterData.undead1st,
			MonsterData.undead2nd,
			MonsterData.undead3rd,
			MonsterData.undead4th,
			MonsterData.valok,
	...
	static orden: Sourcebook = {
		...
		cultures: [
			...
			FactoryLogic.createCulture('Orc', 'Wilderness, anarchic, creative.', CultureType.Ancestral, EnvironmentData.wilderness, OrganizationData.communal, UpbringingData.creative, 'Kalliac'),
			...
			FactoryLogic.createCulture('Time Raider', 'Nomadic, anarchic, martial.', CultureType.Ancestral, EnvironmentData.nomadic, OrganizationData.communal, UpbringingData.martial, 'Voll')
		],
		careers: [],
		classes: [],
		subclasses: [],
