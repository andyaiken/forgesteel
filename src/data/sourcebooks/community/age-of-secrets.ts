		...
		},
		{
			...
			featuresByLevel: [
				...
				},
				{
					level: 2,
					features: [
						FactoryLogic.feature.createMultiple({ id: 'mnemopath-ease-the-telling', name: 'Ease the Telling', features: [
							FactoryLogic.feature.create({ id: 'mnemopath-ease-the-telling-a', name: 'Ease the Telling', description: 'Once per negotiation, when an argument you make would decrease an NPC\'s interest, you can instead take the argument out of their memory: their interest doesn\'t change, and that argument can be made again later in the negotiation as though for the first time.' }),
							FactoryLogic.feature.createRollModifier({ id: 'mnemopath-ease-the-telling-b', name: 'Ease the Telling', modifier: RollModifierType.Edge, condition: 'Retracting, denying, or explaining away something you have already said' })
						] }),
			...
			featuresByLevel: [
				...
				},
				{
					...
					features: [
						...
						FactoryLogic.feature.createMultiple({ id: 'winnower-an-eye-for-the-field', name: 'An Eye for the Field', description: 'You were trained to look at a crowd and see a crop.', features: [
							FactoryLogic.feature.create({ id: 'winnower-an-eye-for-the-field-a', name: 'An Eye for the Field', description: 'When you begin a negotiation, you automatically discover one of the NPC\'s motivations or pitfalls, your choice.' }),
							FactoryLogic.feature.createRollModifier({ id: 'winnower-an-eye-for-the-field-b', name: 'An Eye for the Field', modifier: RollModifierType.Edge, condition: 'Singling one creature out of a group: following a quarry through a mob, picking a face from a lineup, or spotting which member of a delegation is doing the real talking' })
						] }),
