...
export const draachenmar: Sourcebook = {
	...
	languages: [
		// Common languages
		{
			name: 'Caelian',
			description:
        'The language of the ancient Caelian Empire; the common tongue of Orden.',
		...
		},
		{
			name: 'Axiomatic',
			description:
        'Spoken by Memoneks; native language of Axiom; the common language of the timescape by trade.',
			type: LanguageType.Cultural,
			related: []
		},
		{
		...
		},
		{
			name: 'Hyrallic',
			description:
        'Spoken by high elves; the language of interspecies diplomacy.',
			type: LanguageType.Cultural,
			related: []
		},
		{
		...
		},
		{
			name: 'Mindspeech',
			description:
        'Spoken by voiceless talkers; a symbolic language shared among native telepaths.',
			type: LanguageType.Cultural,
			related: []
		},
		{
		...
		},
		{
			name: 'Vhoric',
			description:
        'Spoken by hakaan; offshoot of the stone giant dialect of High Kuric.',
			type: LanguageType.Cultural,
			related: [ 'High Kuric' ]
		},
		{
