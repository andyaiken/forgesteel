...
- It should be possible to add custom keywords to abilities / custom
    weapon or armor types in kits
- It should be possible to create a homebrew class ability / monster
   individually
- Monster Builder:
...
- Encounter Builder:
  - When an encounter has monsters with items, this should be noted in
        the encounter info (monster info and running encounter notes)
    - Encounters should pull in monsters, rather than storing monster /
        group IDs
...
- Tactical Maps:
     Switch map Z level
        - Show (blurred, translucent, no pointer events) levels below /
            above
...
- Encounter
  - Ability to set 'used reaction' flag on heroes / monsters /
        minions
    - Monsters:
...
- Add a way to load / save data from a remote folder / OneDrive /
    Google Docs / iCloud
